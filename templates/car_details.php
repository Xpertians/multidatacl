<form class="needs-validation" novalidate>
  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="modelName" placeholder="" value="<?php if(is_array($this->data['model'])){ echo ($this->data['model'][0]); }else{ echo ($this->data['model']); } ?>" disabled>
    </div>
  </div>
  <div class="mb-3">
